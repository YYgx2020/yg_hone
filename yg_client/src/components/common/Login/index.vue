    ...
    <div class="login_form_wrapper" :class="out? 'out': ''">
      <form action="" class="auth_form">
        ...
        <div class="panel" v-if="toForgetPwd">
          ...
          <div class="input_group">
            <div class="input_box">
              <input v-model="formData.email" maxlength="64" :class="inputSign === '10012' ? 'shake' : ''" class="email_input" type="text" placeholder="请输入注册邮箱" />
            </div>
            <div class="input_box">
              <input v-model="formData.password" maxlength="16" :class="inputSign.indexOf('3') !== -1 ? 'shake' : ''" class="pwd_input" type="password" placeholder="请输入密码" />
            </div>
            <div class="input_box">
              <input v-model="formData.password_again" maxlength="16" :class="inputSign.indexOf('3') !== -1 ? 'shake' : ''" class="pwd_input" type="password" placeholder="请确认密码" />
            </div>
            <!-- 获取验证码 -->
            <div class="input_box">
...
const shakeTime = 800;
const expire_time = 1  // cookie 过期时间 1 天
